...
class GetInTouch extends Component {
  ...
  handleSubmit = () => {
    const templateId = 'template_69zxfmk';
    this.sendFeedback(templateId, {message_html: this.state.comments, from_name: this.state.firstname, reply_to: this.state.email});
